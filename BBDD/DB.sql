...
CREATE TABLE visitas (
    ...
    rut_id           	 NUMBER NOT NULL,
    empleado_rut_empleado NUMBER NOT NULL
);
...
ALTER TABLE visitas
    ADD CONSTRAINT visitas_empleado_fk FOREIGN KEY ( empleado_rut_empleado )
