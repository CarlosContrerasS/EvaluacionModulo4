...
<form method="post" action="EditarCliente">
	...
	Dirección: <input type="text" name="direccion" value="${regcli.getDireccion()}" /><br/><br/>
	
	<input type="hidden" name="idcliente" value="${regcli.getIdCliente()}" /><br/>
	<input type="submit" value="Agregar cliente" value="${regcli.getNombre()}" /><br/>
</form>
